                    ...
                    >
                        ...
                        <div class="emoji-box" style="display: block; left: 86px; top: 209px;">
                            ...
                            <div class="emoji-wrap">
                                <a @click="add_emoji(item)" v-for="(item,key) in emoji_list" class="emoji-list emoji-text"
                                   :data-emoji-text="item"  :key="key">{{item}}</a>
                            </div>
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                if_verify_pass: true, //是否通过验证码，默认为false。
